;deletes everything but: from <chr> to <chr>
...
notes   	DB      cr,lf,'Del2. v3.  /Bushy, 5-Aug-2k3.', cr,lf
        	DB      cr,lf,'Deletes everything but that from <start-chr> to <end-chr>'
        	DB      cr,lf,'del2 <in-file> <out-file> <start-chr> <end-chr> <[0|1]>'
...
@@_61:	
	mov	di, offset Prompt1	; 0 = ignore  <CR>
