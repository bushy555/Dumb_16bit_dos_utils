...
; djm, 01/02/05
;
; Upon finding "\END OF DATA<CR>>" within the input file, will kill it.
...
notes   DB      cr,lf,'01ah Stripper v5.2 +djm, 01/02/05.'
        DB      cr,lf,'Finds \END OF DATA<CR>>, and kills it.'
