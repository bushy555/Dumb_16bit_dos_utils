...
nop
nop
	mov     cl, 8                    ; write 8 char filename
	mov	si, offset onebyte      
...
;       mov     [byte di], ASCnull      ; Store null at end of string
	...
	mov	ah, 0
	mov	cl, 2
	mov	di, offset buffer +14
	call	BinToAscHex

	mov	al, 020h
	mov	di, offset buffer + 16
	stosb
	...
	mov	ah, 0
	mov	cl, 2
	mov	di, offset buffer + 17
	call	BinToAscHex
    			
	mov	al, 020h			; write a spaces
	mov	di, offset buffer + 19
	stosb
