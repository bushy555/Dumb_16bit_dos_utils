...
; djm, 14/09/06
;
; Upon finding 'Hook-Id A' it writes 'Hook-Id A', then followed by next lot of text until 0dh is found.
...
notes   	DB      cr,lf,'Hook-Id A Stripper. djm, 14/9/6.'
        	DB      cr,lf,''
        	DB      cr,lf,'strip32 <input file> <output file>',cr,lf, 0
dot		db	'.',0
...
;05:43:49.60 Process string is A 00000 0 982 000028459885;;ZZZZZZZZ;Y;1001;1;11/09/06;05:21:49;
