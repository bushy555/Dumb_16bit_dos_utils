...
crlf		db	cr,lf,0
notes   	DB      cr,lf,'Strip67  /djm,  12/6/10', cr,lf
        	DB      cr,lf,'removes first 8 chars (spaces) in in-file, if and only if char=0x20h'
        	DB      cr,lf,'For use with IPCONFIG'
        	DB      cr,lf
        	DB      cr,lf,'Strip67  <in-file>  <out-file>'
        	DB      cr,lf,cr,lf,0
