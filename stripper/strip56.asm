; Stripp56  /djm,  13/8/7
;
; Strip56.asm    --- Ignores complete line of single char <param 2> at offset <param 1>. strip56 <in> <out> <par 1> <par 2>
;
;
;
        IDEAL
...
crlf		db	cr,lf,0
notes   	DB      cr,lf,'Stripp56  /djm,  13/8/7', cr,lf
        	DB      cr,lf,'Kills line with char <param 2> at position <param 1>.'
        	DB      cr,lf,'Strip56  <in-file>  <out-file> <0-99> <0-99>',cr,lf,cr,lf
		db	'ie, Strip56 in.txt out.txt 5 Z',cr,lf,'Removes line with a Z at offset 5.',cr,lf
