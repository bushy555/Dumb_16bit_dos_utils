;
;
; Stripper17 --- Xray barcode Stripper
; djm, 3/8/6
;
; For each line:
;   If first three chars = "019" or "O019" then strips first 11 characters, reads and dumps next 5, strips rest of characters, dumps <CR>
;   If first three chars != "019" or "O019" then dump until <CR>
;
...
;327574010032130608033102001800210014
...
@@65:	call	readbyte				; had a 'o' output in front. Get rid of 11 chars.
	call	readbyte				; Four bytes already read.
	call	readbyte
	call	readbyte
	call	readbyte
	call	readbyte
