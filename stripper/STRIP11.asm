...
; djm, 28/11/05
;
; Copies file, adds a comma to the end
;
...
_comma		db	009h, 02ch,0
prompt          DB      cr,lf,'Erase this file? (y/n) ', 0
diskFull        DB      cr,lf,'**ERROR: Disk is full', 0

notes   DB      cr,lf,'Comma adder. djm, 28/11/5.'
        DB      cr,lf,'Copies files, adds a comma.'
        DB      cr,lf,'strip11 <input file> <output file>',cr,lf, 0
...
@@80:
        ...
        mov     dx, offset _comma      ; Address variable with ds:dx
        int     21h                     ; Call DOS to write to file
