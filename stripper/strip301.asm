...
crlf		db	cr,lf,0
notes   	DB      cr,lf,'Stripper301  /djm,  4/9/6', cr,lf
...
slashdash db '-',0
total	db 'Total : ',0
prod0	db 'Date, Product, Totals',0dh,0ah
buffer3	db '0000',0,0
com	db ', ',0
...
@@40:   mov     [outFile], ax           ; Save output file handle
	...
	mov     ah, 40h                 	; Write 'date,prod,totals'
        mov     bx, [outFile]           	
        mov     cx, 23
        mov     dx, offset prod0
        int     21h				
