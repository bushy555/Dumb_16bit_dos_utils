;
;
; Stripper62 --- Xray barcode Stripper. (strip 26 version 2!)
; djm, 18/1/8
; Extracts product and carton number from barcode
; Frominput file of raw barcodes, ie:
;0199327574010032130608033102001800210014_010108_120000
;0199327574010032130608033102001800210014_010108_120002
;0199327574010032130608033102001800210014_010108_120004
;
;will output:
; product , Carton Number , Prod date , Full barcode , 0dh,0ah,0
;01005,0001,150806,019932757401005613060815310200158021000,010108,120000
;01005,0002,150806,019932757401005613060815310200162021000,010108,120000
;01005,0003,150806,019932757401005613060815310200159021000,010108,120000
;01005,0004,150806,019932757401005613060815310200158021000,010108,120000
;01005,0005,150806,019932757401005613060815310200161021000,010108,120000
;01005,0006,150806,019932757401005613060815310200188021000,010108,120000
;01005,0007,150806,019932757401005613060815310200166021000,010108,120000
;01005,0008,150806,019932757401005613060815310200193021000,010108,120000
;01005,0009,150806,019932757401005613060815310200157021000,010108,120000
;01005,0010,150806,019932757401005613060815310200148021001,010108,120000
;01005,0011,150806,019932757401005613060815310200176021001,010108,120000
;01005,0012,150806,019932757401005613060815310200157021001,010108,120000
;01005,0013,150806,019932757401005613060815310200174021001,010108,120000
...
notes   	DB      cr,lf,'Stripper 62 v2. djm, 18/1/8.'
	        DB      cr,lf,'.'
	        DB      cr,lf,'strip62 <input file> <output file>',cr,lf, 0
barcode		db	'0199327574010032130608033102001800210014_010108_120000'
label1		db	'Product,Carton Number,Prod date,Full barcode,date,time',0dh,0ah,0
...
@@68:	mov	al, [di]
	...
	mov	di, offset barcode + 41 	; write entire barcode
	mov	cx, 6
@@69:	mov	al, [di]
	call	writebyte
	inc	di
	...
	mov	di, offset barcode + 48 	; write entire barcode
	mov	cx, 6
@@70:	mov	al, [di]
	call	writebyte
	inc	di
