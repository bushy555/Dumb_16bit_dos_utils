...
; strip 87
;
; dumps first line, up and including <CR>   (0x0Dh, 0x0Ah)
;djm. 21/11/11
;
...
crlf		db	cr,lf,0
notes   	DB      cr,lf,'Stripper87  /djm,  21/11/11', cr,lf
        	DB      cr,lf,'Dumps first line.'
        	DB      cr,lf,'Stripper87  <in-file>  <out-file>'
        	DB      cr,lf,cr,lf,0
