; Stripa2.asm
; strips serial number of 2, dumps into an output file
; Frozen xray barcode reader.
;
...
@@_42:	mov     ah, 40h                 	; DOS Write-file function
        mov     bx, [outFile]           	; Set bx to output file handle
        mov     cx, 60		      		; Specify one byte to write
