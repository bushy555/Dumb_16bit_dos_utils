; Stripp44  /djm,  5/6/7
;
; Kills first <99> characters at offset 0
;
; STRIP44 in.txt out.txt 5
; STRIP44 in.txt out.txt 34
;
;
;
        IDEAL
...
crlf		db	cr,lf,0
notes   	DB      cr,lf,'Stripp44  /djm,  5/6/7', cr,lf
        	DB      cr,lf,'Kills first <99> characters at offset 0 per line. (1 to 99).'
        	DB      cr,lf,'Stripp44  <in-file>  <out-file> <99>',cr,lf,cr,lf
		db	'ie, Stripp44 in.txt out.txt 5',cr,lf,'    Stripp44 in.txt out.txt 34',cr,lf
