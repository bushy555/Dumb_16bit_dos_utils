; Strip50.asm
; strips new weather station to extract average, minimum and maximum from weather data.

;16/07/07   maximum,   11.062,   21.700,   10.106,      0.0,    704.4,    84.31,   144.19,    76.36,        0,    12.36,   360.00,   103.26,
;16/07/07   minimum,    2.562,    1.312,    6.906,      0.0,     17.4,    50.91,   141.40,    40.50,        0,     0.00,     0.01,     1.51,
;16/07/07   average,    6.608,    7.912,    8.412,      0.0,    105.7,    70.25,    28.67,    54.50,        0,     1.14,   345.23,    67.08,
...
crlf		db	cr,lf,0
notes   	DB      cr,lf,'Stripper50  /djm,  20/7/7', cr,lf
        	DB      cr,lf,'weather station stripper.'
        	DB      cr,lf,'Stripper50  <in-file>  <out-file>'
        	DB      cr,lf,cr,lf,0
...
@@_42:	
	...
	mov     ah, 40h                 	; DOS Write-file function
        ...
        mov     cx, 139		      		; Specify one byte to write
