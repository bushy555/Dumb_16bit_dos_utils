; Stripper963  /djm,  2/4/12
;
; Kills first 38 characters at offset 0
;
;
;
        IDEAL
...
crlf		db	cr,lf,0
notes   	DB      cr,lf,'Stripper963  /djm,  02/4/12', cr,lf
        	DB      cr,lf,'Kills first 38 characters at offset 0 per line.'
        	DB      cr,lf,'Stripper963  <in-file>  <out-file>'
        	DB      cr,lf,cr,lf,0
...
@@_45:	
	...
	; #############################################################
	; ###                                                       ###
	; ###   REMOVES FIRST <X> characters at position 0.  ie, 38 ###
	; ###                                                       ###
	; #############################################################
	; #############################################################
