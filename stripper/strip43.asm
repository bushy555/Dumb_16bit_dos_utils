...
; djm, 5/6/7
;
; Upon finding single character <param 3> within the <in-file>, will kill it, output to <out-file>
; strip43 <in-file> <out-file> <character>
;
...
notes   DB      cr,lf,'Strip43. djm, 5/6/7.'
        DB      cr,lf,'Finds single character <param 3> and kills it.'
        DB      cr,lf,'strip43 <input file> <output file> <char>',cr,lf, 0
...
;--------------------------------------------------------------------------
	...
	mov     cx, 2                   ; Specify parameter number 1
        call    GetOneParam             ; Get address of parameter string
        mov     bl, [di]                ; Address file name with ds:dx
