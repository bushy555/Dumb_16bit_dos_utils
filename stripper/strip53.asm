;
;
; Stripper 53 - for kronos.   Cleans up listing - displays only names and 'on site' times.
; djm, 13/08/07
;
;
...
notes   	DB      cr,lf,'Kronos listing Stripper. djm, 13/8/7'
        	DB      cr,lf,''
        	DB      cr,lf,'strip53 <input file> <output file>',cr,lf, 0
dot		db	'.',0
option1		db	0
count0		dw	0
count1		dw	0
