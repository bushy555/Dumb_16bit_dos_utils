...
;           0199327574530653130801173102001870210003_080117_062504
buffer1	db '                                                             ',0,0,0
buffer2	db '                                                             ',0,0,0
buffer3 db '     ',0
read1	db 'X$'
...
;	mov	di, offset buffer0 + 54
;	mov	al, [di]
;	cmp	al, 0dh
;	je	@@_42
;	jmp	@@_40

;	123456789012345678901234567890123456789012345678901234    (54 + 2)
;	0199327574530653130801173102001870210003_080117_062504    <0D> <0A>


@@_42:	mov	di, offset buffer0 
	mov     ah, 40h                 	; DOS Write-file function
        mov     bx, [outFile]           	; Set bx to output file handle
        mov     cx, 54		      		; Specify one byte to write
