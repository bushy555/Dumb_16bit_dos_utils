; Stripper108.   /djm.  19 march 2018
;
; invalid character finder. finds (exports/dumps) charcters < 32 and > 122
;
;
;
        IDEAL
...
notes   	DB      cr,lf,'Stripper14  /djm,  14/6/6', cr,lf
        	...
        	DB      cr,lf,cr,lf,0
message1	db	cr,lf,'decimal point is in the correct place',cr,lf,0
...
@@_45:	call	readbyte	
	cmp	al, 32
	ja	@@_50				; jump if above <space>
						; otherwise : DO if below <space>

@@_502:	cmp	al, 20h
	je	@@_50				; If <space> then ignore and jump


	cmp	al, 0dh
	je	@@_451
	jmp	@@_453				; invalid char. write it out.


@@_451:	call	readbyte			; readnext char for 'is it <CR>?'

	cmp	al, 0ah				; Valid <CR>. ignore and jump
	je	@@_50
...
@@_452:
	...
	call	writebyte			; display invalid character
	call	readbyte	
	call	writebyte	
